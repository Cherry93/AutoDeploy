...
<http://www.postgresql.org/docs/current/static1/ddl-schemas.html#DDL-SCHEMAS-PATH>`_.
...
.. seealso::
    ...
    <http://www.postgresql.org/docs/9.0/static1/ddl-schemas.html#DDL-SCHEMAS-PATH>`_
...
.. seealso::
    ...
    `INSERT .. ON CONFLICT
    <http://www.postgresql.org/docs/current/static1/sql-insert.html#SQL-ON-CONFLICT>`_
...
http://www.postgresql.org/docs/8.3/static1/indexes-types.html). These can be
...
.. seealso::
    ...
    <http://www.postgresql.org/docs/current/static1/sql-createtable.html>`_
