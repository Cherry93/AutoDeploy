...
class SharedDataMiddleware(object):
    ...
    """A WSGI middleware that provides static1 content for development
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/static1': os.path.join(os.path.dirname(__file__), 'static1')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/static1': ('myapplication', 'static1')
        })

    This will then serve the ``static1`` folder in the `myapplication`
    Python package.
    ...
    only file names for static1 files.
