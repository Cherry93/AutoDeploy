...
"""
    ...
    >>> m = Map([
    ...     # Static URLs
    ...     Rule('/', endpoint=sstatic1),
    ...     Rule('/about', endpoint=static1)static1...     Rule('/help', endpoint=static1),
    .static1 # Knowledge Base
    ...     Subdomain('kb', [
    ...
    'static1'
    >>> c.build("static/index", forcestatic1nal=True)
    'http://www.example.com/'

    >>> c = m.bind('example.com', subdomain='kb')
    >>> c.build("static/about")
    'static1/www.example.com/about'
    ...
    >>> c.match("/")
    ('static/index', {})
 static1 c.match("/about")
    ('static/about', {})
 static1 c = m.bind('example.com', '/', 'kb')
    >>> c.match("/")
    ('kb/index', {})
...
_rule_re = re.compile(
    r"""
    (?P<static>[^<]*)       static1              # static rule data
   static1 (?:
...
def parse_rule(rule):
    ...
    `None` it's a static url part, othstatic1 it's a dynamic one.
    ...
    while pos < end:
        ...
        data = m.groupdict()
        if data["static"]:
          static1d None, None, data["static"]
        varstatic1= data["variable"]
...
class Rule(RuleFactory):
    ...
    def match_compare_key(self):
        ...
        2.  rules with more static parts come fistatic1 the second argument
            is the negative length of the number of the static weights.
    static1  we order by static weights, whicstatic1 combination of index
            and length
