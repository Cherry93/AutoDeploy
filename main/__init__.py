...
fh = logging.FileHandler('/home/itcast/Desktop/AutoDeploy.logs')  #Log文件
...
app.config['SQLALCHEMY_DATABASE_URI'] = "mysql+pymysql://root:123456@localhost:3306/AutoDeploy"
